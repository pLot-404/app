...
/***/ "./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js??ruleSet[1].rules[0].use[2]!./src/css/Style.scss":
/*!*************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js??ruleSet[1].rules[0].use[2]!./src/css/Style.scss ***!
  \*************************************************************************************************************************************/
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "body {\n  color: green;\n  background-color: yellow;\n}", "",{"version":3,"sources":["webpack://./src/css/Style.scss"],"names":[],"mappings":"AAGA;EACE,YAJQ;EAKR,wBAJW;AAEb","sourcesContent":["$p_color: green;\n$p_bg_color: yellow;\n\nbody {\n  color: $p_color;\n  background-color: $p_bg_color;\n}\n"],"sourceRoot":""}]);
// Exports
...
var Game = /** @class */ (function () {
    function Game(width, height) {
        ...
        _a = [width, height], this.canvas.width = _a[0], this.canvas.height = _a[1];
        this.objs = [];
        this.keyMap = {};
    }
    ...
    Game.prototype.setKeyBind = function (name, code) {
        this.keyMap[name] = {
            keyCode: code,
            push: false,
        };
...
var Sprite = /** @class */ (function () {
    function Sprite(img, x, y, width, height, index) {
        if (x === void 0) { x = 0; }
        if (y === void 0) { y = 0; }
    ...
    Sprite.prototype.render = function (canvas) {
        ...
        var xIndex = this.index % (this.img.width / this.width);
        var yIndex = Math.floor(this.index / (this.img.width / this.width));
        ctx.drawImage(this.img, this.width * xIndex, this.height * yIndex, this.width, this.height, this.x, this.y, this.width, this.height);
    };
    return Sprite;
}());
...
/* harmony import */ var _modules_Sprite__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/Sprite */ "./src/modules/Sprite.ts");
...
window.addEventListener('load', function () {
    var game = new _modules_Game__WEBPACK_IMPORTED_MODULE_0__["default"](window.innerWidth * 0.95, window.innerHeight * 0.95);
    for (var i in keys) {
    ...
    var school = new _modules_Sprite__WEBPACK_IMPORTED_MODULE_1__["default"]('./img/school_A5.png');
    game.add(school);
    game.start();
});
